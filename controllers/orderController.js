...
const createOrder = async (req, res)=>{
    ...
    const order = await Order.create({
        orderItems,total, subtotal, tax, shippingFee, client_secret: paymentIntent.client_secret, user: req.user.userId
    })
...
const getCurrentUserOrders = async (req, res)=>{
    ...
    res.status(StatusCodes.OK).json({numOfOrders: order.length, order})
}
